...
cd ~
{
git clone https://github.com/enty8080/utopia.git
} &> /dev/null
fi
...
{
cd bin
cp utopia /usr/local/bin
chmod +x /usr/local/bin/utopia
cp utopia /bin
chmod +x /bin/utopia
cp utopia /data/data/com.termux/files/usr/bin
chmod +x /data/data/com.termux/files/usr/bin/utopia
} &> /dev/null
